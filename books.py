...
aliceInWonderland = Book("Alice in Wonderland", "Lewis Carroll", """
...
poeTalesPoems = Book("Complete Tales and Poems", "Edgar Allan Poe", """
...
madnessBipolar = Book("Madness: A Bipolar Life", "Marya Hornbacher", """
...
furiouslyHappy = Book("Furiously Happy", "Jenny Lawson", """
...
firstStep = Book("The First Step", "Emm Roy", """
